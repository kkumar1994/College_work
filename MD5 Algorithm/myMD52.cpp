...
cout<<"number of ones in a0 is "<<bitCount(a0)<<endl;
cout<<"number of ones in b0 is "<<bitCount(b0)<<endl;
cout<<"number of ones in c0 is "<<bitCount(c0)<<endl;
cout<<"number of ones in d0 is "<<bitCount(d0)<<endl;
