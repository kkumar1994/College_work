...
#tokenize("Hi there! Isn't this fun?", keep_internal_punct=True)
#tokenize("Hi there how are you? Don't you ... #awesome @awesome http://www.good.com", keep_internal_punct=True)
...
def token_pair_features(tokens, feats, k=3):
    ...
    while(i<len(tokens)):
        ...
        while((j<len(tokens))and(j!=len(tokens))):
            #print(j)
...
def featurize(tokens, feature_fns):
    ...
    for i in tokens:
        ...
        for n in feature_fns:
            if(n==feature_fns):    
                return token_features(tokens, feats)
            elif(n==lexicon_features):
                return lexicon_features(tokens, feats)
            else:
                pass
...
def plot_sorted_accuracies(results):
    ...
    accuracies = []
    plt.figure()
    plt.plot(setting, accuracies, 'bo-')
    plt.xlabel('setting')
    plt.ylabel('accuracy')
    plt.show()
